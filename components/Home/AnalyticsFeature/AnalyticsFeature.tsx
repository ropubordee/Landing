...
const AnalyticsFeature = () => {
  ...
  <p className="mt-4 text-gray-600 text-sm font-medium leading-[2rem]">
    Figma empowers designers and teams to create, prototype, and collaborate in real time. 
    Work efficiently with powerful features that bring ideas to life.
  </p>
  ...
  <button className="mt-8 px-8 py-3 bg-purple-500 text-white font-semibold rounded-full hover:bg-purple-700
